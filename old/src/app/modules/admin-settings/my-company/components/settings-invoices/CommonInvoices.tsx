...
const CommonInvoices = ({ setModalOpen }: Props) => {
        ...
        <div className="modal-dialog modal-dialog-centered mw-700px">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="row mb-6">
                <label className="col-lg-4 col-form-label fw-bold fs-6">
                  {/* {intl.formatMessage({ id: "Fields.InvoiceNrFormatLabel" })} */}
                  uitleg opmaak factuurnummer
                </label>
                ...
                <div className="col-lg-8 fv-row">
                  ...
                  >
                    ...
                    <div className="col-10 text-primary">
                      ...
                      // dangerouslySetInnerHTML={{
                      //   __html: intl.formatMessage({
                      //     id: "Fields.InvoiceNrFormatInfo",
                      //   }),
                      // }}
                      >
                        Bepaal hier het format van jouw factuurnummers.
                        Hieronder zie je een voorbeeld en wat de mogelijkheden
                        zijn. Bijvoorbeeld: I%year%-%nr% wordt I2024-0001
                        Placeholders: %yyyy% = huidig jaartal, voorbeeld: 2024
                        %yy% = huidig jaartal, voorbeeld: 24 %nr% = huidige
                        factuur index, voorbeeld: 0001 %nr1% = huidige factuur
                        index, voorbeeld: 1 %nr2% = huidige factuur index,
                        voorbeeld: 01 %nr3% = huidige factuur index, voorbeeld:
                        001 %fdd% = dag factuurdatum, voorbeeld: 23 %fmm% =
                        maand factuurdatum, voorbeeld: 05 %fyy% = jaar
                        factuurdatum, voorbeeld: 24 %fyyyy% = jaar factuurdatum,
                        voorbeeld: 2024
                      </span>
                    </div>
                  </div>
