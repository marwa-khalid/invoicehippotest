...
export interface FormValues {
  ...
  contactlist:
    | {
        contacts: any[]; // Array of strings for contact names, IDs, or details
        listOfDeletedClientContactIDs: number[]; // Array of numbers for deleted contact IDs
      }
    | any;
        ...
        <form className="form p-6" noValidate>
          ...
          <div className="row flex-grow-1 d-flex mb-5">
            ...
            <Select
              ...
              options={getEnumOptions(enums.ClientTypes, intl)}
              value={formik.values.clientTypes
                ...
                .map((clientTypeValue) => {
                  const clientType = getEnumOptions(
                    enums.ClientTypes,
                    intl
                  ).find((ct) => ct.value === clientTypeValue);
                  return {
              ...
              <div className="row d-flex mb-5">
                ...
                <div className="fv-row col-5">
                  <input
                    ...
                    value={formik.values.invoiceAddress.streetName || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.Street",
                    })}
                ...
                <div className="fv-row col-3">
                  <input
                    ...
                    value={formik.values.invoiceAddress.houseNr || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.HouseNr",
                    })}
                ...
                <div className="fv-row col-4">
                  <input
                    ...
                    value={formik.values.invoiceAddress.houseNrAddition || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
              ...
              <div className="row d-flex mb-5">
                ...
                <div className="fv-row col-6">
                  <input
                    ...
                    value={formik.values.invoiceAddress.postCode || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.PostCode",
                    })}
                ...
                <div className="fv-row col-6">
                  <input
                    ...
                    className="form-control form-control-solid"
                    value={formik.values.invoiceAddress.city || ""}
                    placeholder={intl.formatMessage({
                      id: "Fields.City",
                    })}
                  />
              ...
              <div className="row d-flex mb-5">
                ...
                <div className="fv-row col-4">
                  <input
                    ...
                    value={formik.values.deliveryAddress.streetName || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.Street",
                    })}
                ...
                <div className="fv-row col-4">
                  <input
                    ...
                    value={formik.values.deliveryAddress.houseNr || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.HouseNr",
                    })}
                ...
                <div className="fv-row col-4">
                  <input
                    ...
                    value={formik.values.deliveryAddress.houseNrAddition || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.HouseNrAddon",
                    })}
              ...
              <div className="row d-flex mb-5">
                ...
                <div className="fv-row col-6">
                  <input
                    ...
                    value={formik.values.deliveryAddress.postCode || ""}
                    className="form-control form-control-solid"
                    placeholder={intl.formatMessage({
                      id: "Fields.PostCode",
                    })}
