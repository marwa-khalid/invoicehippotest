...
function Invoice3_LightBlue() {
     return (
          <div>
               <div className={styles.hippo_tpl002_beeinvoicepage_LightBlue}>
                    <div className={styles.hippo_tpl002_beeinvoicepage}>
                         <div className={styles.hippo_tpl002_header}>
                              <img className={styles.hippo_tpl002_logo} src="images/ready-logo-lightblue.svg" alt="" />
                         </div>
...
export default Invoice3_LightBlue
