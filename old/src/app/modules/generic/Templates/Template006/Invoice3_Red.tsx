...
function Invoice3_Red() {
     return (
          <div>
               <div className={styles.hippo_tpl002_beeinvoicepage_red}>
                    <div className={styles.hippo_tpl002_beeinvoicepage}>
                         <div className={styles.hippo_tpl002_header}>
                              <img className={styles.hippo_tpl002_logo} src="images/ready-logo-red.svg" alt="" />
                         </div>
