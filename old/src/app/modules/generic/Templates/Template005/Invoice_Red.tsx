...
function Invoice2_red() {
     return (
          <div className={styles.hippo_tpl004_invoice2_red}>
                    ...
                    <table className={styles.hippo_tpl004_invoice_table2}>
                         <thead>
                              <tr className={styles.hippo_tpl004_invoice_header2}>
                                   <th className={styles.hippo_tpl004_box}><span className={styles.hippo_tpl006_box}></span></th>
                         ...
                         <tbody>
                              {data.map((item, index) => (
                                   ...
                                   >
                                        <td className={styles.hippo_tpl005_box}></td>
