...
import { CostPostResult } from "../../../accounting/costs/components/core/_models";
...
const CostAddStep1: FC<Props> = ({ formik, refresh, setRefresh }) => {
  ...
  const handleQuillChange1 = (content: string) => {
    formik.setFieldValue("comments.privateComments", content); // Set only the privateComments field
  };
        ...
        <form className="form p-4" noValidate>
          <div className="row d-flex mb-5">
            ...
            <div className="col-3">
              ...
              >
                <Flatpickr
                  value={formik.values.header.invoiceDueDate}
                  onChange={(date: Date[]) =>
                    formik.setFieldValue(
            ...
            {/* <div className="col-4">
              <label className="required fw-bold fs-6 mb-3">
                {intl.formatMessage({ id: "Fields.CostType" })}
              </label>
              <Select
                className={clsx(
                ...
                options={getEnumOptions(enums.ReceiptBookingTypes, intl)}
                value={
                  formik.values.registrationType === 0
                    ? null
                    : getEnumOptions(enums.ReceiptBookingTypes, intl).find(
                        (item) => item.value === formik.values.registrationType
                      ) || null
                }
                ...
                formik.errors.registrationType && (
                  <div className="fv-plugins-message-container">
                    <div className="fv-help-block">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: formik.errors.registrationType,
                        }}
                        role="alert"
                      />
                    </div>
