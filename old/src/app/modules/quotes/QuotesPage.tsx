...
import { QuoteListWrapper } from "./overview/QuoteListWrapper";
import clsx from "clsx";
import { useLayout } from "../../../_metronic/layout/core";
import { useIntl } from "react-intl";
import { QuoteViewWrapper } from "./overview/QuoteViewWrapper";
...
const QuotesPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      const quoteNr = JSON.parse(localStorage.getItem("currentNr")!);
