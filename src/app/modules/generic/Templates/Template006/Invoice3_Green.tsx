...
function Invoice3_Green() {
     return (
          <div>
               <div className={styles.hippo_tpl002_beeinvoicepage_green}>
                    <div className={styles.hippo_tpl002_beeinvoicepage}>
                         <div className={styles.hippo_tpl002_header}>
                              <img className={styles.hippo_tpl002_logo} src="images/ready-logo-green.svg" alt="" />
                         </div>
