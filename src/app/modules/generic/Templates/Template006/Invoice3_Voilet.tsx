...
function Invoice3_Voilet() {
     return (
          <div>
               <div className={styles.hippo_tpl002_beeinvoicepage_voilet}>
                    <div className={styles.hippo_tpl002_beeinvoicepage}>
                         <div className={styles.hippo_tpl002_header}>
                              <img className={styles.hippo_tpl002_logo} src="images/ready-logo-violet.svg" alt="" />
                         </div>
...
export default Invoice3_Voilet
