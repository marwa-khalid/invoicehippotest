...
function Invoice3_Gray() {
     return (
          <div className={styles.hippo_tpl002_beeinvoicepage_gray}>
               <div className={styles.hippo_tpl002_beeinvoicepage}>
                    <div className={styles.hippo_tpl002_header}>
                         <img className={styles.hippo_tpl002_logo} src="images/ready-logo-gray.svg" alt="" />
                    </div>
