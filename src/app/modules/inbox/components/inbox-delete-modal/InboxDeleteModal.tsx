...
import { InboxDeleteModalHeader } from "./InboxDeleteModalHeader";
import { InboxDeleteModalFooter } from "./InboxDeleteModalFooter";
          ...
          <div className="modal-content">
            ...
            <div className="modal-body p-10">
              <div className="row d-flex form-wrapper bg-secondary p-5 rounded">
                ...
                >
                <FormattedMessage
                  id="Fields.ModalDeleteDescriptionInbox"
                  values={{ 0: "0" }}
                />
                </span>
              </div>
