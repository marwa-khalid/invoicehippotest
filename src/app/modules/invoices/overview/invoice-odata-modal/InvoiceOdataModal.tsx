...
import { InvoiceOdataModalHeader } from "./InvoiceOdataModalHeader";
import { InvoiceOdataModalFooter } from "./InvoiceOdataModalFooter";
      ...
      >
        ...
        <div className="modal-dialog modal-dialog-centered mw-600px">
          ...
          <div className="modal-content">
            <InvoiceOdataModalHeader setOdataModalOpen={setOdataModalOpen} />
            {/* begin::Modal body */}
