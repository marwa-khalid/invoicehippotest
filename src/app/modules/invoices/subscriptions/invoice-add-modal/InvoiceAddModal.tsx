...
import { SubscriptionAddStep5 } from "./SubscriptionAddStep5";
import { ExtraOptionsModal } from "../../overview/extra-options-modal/ExtraOptionsModal";
interface Props {
...
const InvoiceAddModal = ({
  ...
  const tabs = [
    {
      id: "tab1",
      label: intl.formatMessage({ id: "Fields.ActionSubscriptionOptions" }),
      icon: "ki-solid ki-calendar fs-3 hippo-tab-icon",
    },
    {
      id: "tab2",
    ...
    <>
      ...
      >
        ...
        <div className="hippo-tab-content" id="myTabContent">
          ...
          {activeTab.id === "tab5" && <SubscriptionAddStep5 formik={formik} />}
        </div>
        {extraOptionsModal && (
          <ExtraOptionsModal
            formik={formik}
