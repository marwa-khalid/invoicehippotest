...
export interface AuthResult {
  ...
  redirectToModuleInstanceUniqueId: string | null;
  hasRedirectToModuleInstanceUniqueId: boolean;
  hasRedirectToModuleInstanceId: boolean;
...
export interface UserResult {
  ...
  thirdPartySettings: { userIntercomIoHash: string };
  accountant: {
    id: number;
    title: string;
    companyLogoUrl: string;
