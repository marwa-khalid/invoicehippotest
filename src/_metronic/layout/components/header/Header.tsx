  ...
  return (
    ...
    >
      ...
      <div className="position-relative">
        ...
        <input type="text" className="search-input form-control form-control border h-lg-45px rounded-lg ps-13 pl-5" name="search" value="" placeholder="Search..." data-kt-search-element="input"/>
      </div>
    </div>
  )
}
